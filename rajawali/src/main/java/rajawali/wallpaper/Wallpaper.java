...
public abstract class Wallpaper extends WallpaperService {
    ...
    protected class WallpaperEngine extends Engine {
        ...
        public WallpaperEngine(SharedPreferences preferences, Context context, RajawaliRenderer renderer) {
            this( context, renderer, false);
        }

        public WallpaperEngine( Context context, RajawaliRenderer renderer,
                               boolean useMultisampling) {
            mContext = context;
            mRenderer = renderer;
            mRenderer.setSharedPreferences(PreferenceManager.getDefaultSharedPreferences(context));
        ...
        @Override
        public void onDestroy() {
            Log.e("linhon", "wallpaper destroy");
            setTouchEventsEnabled(false);
